...
export declare namespace MediaListParams {
    /**
     * Consolidated filter parameter (deepObject style). Originally:
     * filter[content_type][]
     */
...
export declare namespace Media {
    export { type MediaResource as MediaResource, type MediaRetrieveResponse as MediaRetrieveResponse, type MediaUpdateResponse as MediaUpdateResponse, type MediaListResponse as MediaListResponse, type MediaUploadResponse as MediaUploadResponse, type MediaUpdateParams as MediaUpdateParams, type MediaListParams as MediaListParams, type MediaUploadParams as MediaUploadParams, };
}
