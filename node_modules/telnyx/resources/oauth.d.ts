...
export declare namespace OAuthRetrieveResponse {
    interface Data {
        /**
         * Client ID
         */
...
export declare namespace OAuthRetrieveJwksResponse {
    interface Key {
        /**
         * Algorithm
         */
