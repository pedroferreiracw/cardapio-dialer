...
export declare namespace BucketRetrieveResponse {
    interface Data {
        created_at: string;
        filename: string;
        status: string;
...
export declare namespace Buckets {
    export { type BucketRetrieveResponse as BucketRetrieveResponse, type BucketListResponse as BucketListResponse, };
}
