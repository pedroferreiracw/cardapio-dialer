...
import { TagAddParams, TagAddResponse, TagListResponse, TagRemoveParams, TagRemoveResponse, Tags } from "./tags.mjs";
import * as ToolsAPI from "./tools.mjs";
import { ToolAddParams, ToolAddResponse, ToolRemoveParams, ToolRemoveResponse, ToolTestParams, ToolTestResponse, Tools } from "./tools.mjs";
...
import { AssistantTest, AssistantTestsDefaultFlatPagination, TelnyxConversationChannel, TestCreateParams, TestListParams, TestUpdateParams, Tests } from "./tests/tests.mjs";
...
export declare namespace InferenceEmbeddingWebhookToolParams {
    ...
    namespace Webhook {
        ...
        interface StoreFieldsAsVariable {
            /**
...
export declare namespace TransferTool {
    interface Transfer {
        /**
         * Number or SIP URI placing the call.
         */
...
export declare namespace WebhookTool {
    interface Webhook {
        /**
         * The description of the tool.
         */
...
export declare namespace Assistants {
    ...
    export { Tags as Tags, type TagListResponse as TagListResponse, type TagAddResponse as TagAddResponse, type TagRemoveResponse as TagRemoveResponse, type TagAddParams as TagAddParams, type TagRemoveParams as TagRemoveParams, };
}
