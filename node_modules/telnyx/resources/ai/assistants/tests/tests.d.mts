...
import { RunListParams, RunRetrieveParams, RunTriggerParams, Runs, TestRunDetailResult, TestRunResponse, TestRunResponsesDefaultFlatPagination, TestStatus } from "./runs.mjs";
...
export declare namespace Tests {
    ...
    export { Runs as Runs, type TestRunDetailResult as TestRunDetailResult, type TestRunResponse as TestRunResponse, type TestStatus as TestStatus, type TestRunResponsesDefaultFlatPagination as TestRunResponsesDefaultFlatPagination, type RunRetrieveParams as RunRetrieveParams, type RunListParams as RunListParams, type RunTriggerParams as RunTriggerParams, };
}
