...
class Assistants extends resource_1.APIResource {
     ...
     * ```
     */
    sendSMS(assistantID, body, options) {
        return this._client.post((0, path_1.path) `/ai/assistants/${assistantID}/chat/sms`, { body, ...options });
    }
}
