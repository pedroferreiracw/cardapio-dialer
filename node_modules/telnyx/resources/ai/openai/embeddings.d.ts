...
export declare namespace EmbeddingCreateEmbeddingsResponse {
    interface Data {
        /**
...
export declare namespace EmbeddingListEmbeddingModelsResponse {
    interface Data {
        /**
...
export declare namespace Embeddings {
    export { type EmbeddingCreateEmbeddingsResponse as EmbeddingCreateEmbeddingsResponse, type EmbeddingListEmbeddingModelsResponse as EmbeddingListEmbeddingModelsResponse, type EmbeddingCreateEmbeddingsParams as EmbeddingCreateEmbeddingsParams, };
}
