 ...
 */
export declare class MobileVoiceConnections extends APIResource {
    /**
...
export declare namespace MobileVoiceConnection {
    interface Inbound {
...
export declare namespace MobileVoiceConnectionCreateParams {
    interface Inbound {
...
export declare namespace MobileVoiceConnectionUpdateParams {
    interface Inbound {
        channel_limit?: number;
    }
    interface Outbound {
...
//# sourceMappingURL=mobile-voice-connections.d.mts.map