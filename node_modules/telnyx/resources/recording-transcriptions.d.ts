 ...
 */
export declare class RecordingTranscriptions extends APIResource {
    /**
...
export declare namespace RecordingTranscriptionListParams {
    /**
     * Filter recording transcriptions by various attributes.
     */
    interface Filter {
...
export declare namespace RecordingTranscriptions {
    export { type RecordingTranscription as RecordingTranscription, type RecordingTranscriptionRetrieveResponse as RecordingTranscriptionRetrieveResponse, type RecordingTranscriptionDeleteResponse as RecordingTranscriptionDeleteResponse, type RecordingTranscriptionsDefaultFlatPagination as RecordingTranscriptionsDefaultFlatPagination, type RecordingTranscriptionListParams as RecordingTranscriptionListParams, };
}
//# sourceMappingURL=recording-transcriptions.d.ts.map