 ...
 */
export declare class UserTags extends APIResource {
    /**
     * List all user tags.
     */
...
export declare namespace UserTagListResponse {
    interface Data {
        /**
...
export declare namespace UserTagListParams {
    /**
     * Consolidated filter parameter (deepObject style). Originally:
     * filter[starts_with]
     */
...
//# sourceMappingURL=user-tags.d.mts.map