 ...
 */
export declare class MigrationSources extends APIResource {
    /**
...
export declare namespace MigrationSourceParams {
...
export declare namespace MigrationSourceCreateParams {
    interface ProviderAuth {
        /**
         * AWS Access Key. For Telnyx-to-Telnyx migrations, use your Telnyx API key here.
         */
