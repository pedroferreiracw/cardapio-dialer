...
import { ActionRequirementInitiateParams, ActionRequirementInitiateResponse, ActionRequirementListParams, ActionRequirementListResponse, ActionRequirementListResponsesDefaultFlatPagination, ActionRequirements } from "./action-requirements.mjs";
...
import { ActivationJobListParams, ActivationJobRetrieveParams, ActivationJobRetrieveResponse, ActivationJobUpdateParams, ActivationJobUpdateResponse, ActivationJobs } from "./activation-jobs.mjs";
import * as AdditionalDocumentsAPI from "./additional-documents.mjs";
import { AdditionalDocumentCreateParams, AdditionalDocumentCreateResponse, AdditionalDocumentDeleteParams, AdditionalDocumentListParams, AdditionalDocumentListResponse, AdditionalDocumentListResponsesDefaultFlatPagination, AdditionalDocuments } from "./additional-documents.mjs";
import * as AssociatedPhoneNumbersAPI from "./associated-phone-numbers.mjs";
import { AssociatedPhoneNumberCreateParams, AssociatedPhoneNumberCreateResponse, AssociatedPhoneNumberDeleteParams, AssociatedPhoneNumberDeleteResponse, AssociatedPhoneNumberListParams, AssociatedPhoneNumbers, PortingAssociatedPhoneNumber, PortingAssociatedPhoneNumbersDefaultFlatPagination } from "./associated-phone-numbers.mjs";
import * as CommentsAPI from "./comments.mjs";
import { CommentCreateParams, CommentCreateResponse, CommentListParams, CommentListResponse, CommentListResponsesDefaultFlatPagination, Comments } from "./comments.mjs";
import * as PhoneNumberBlocksAPI from "./phone-number-blocks.mjs";
import { PhoneNumberBlockCreateParams, PhoneNumberBlockCreateResponse, PhoneNumberBlockDeleteParams, PhoneNumberBlockDeleteResponse, PhoneNumberBlockListParams, PhoneNumberBlocks, PortingPhoneNumberBlock, PortingPhoneNumberBlocksDefaultFlatPagination } from "./phone-number-blocks.mjs";
import * as PhoneNumberConfigurationsAPI from "./phone-number-configurations.mjs";
import { PhoneNumberConfigurationCreateParams, PhoneNumberConfigurationCreateResponse, PhoneNumberConfigurationListParams, PhoneNumberConfigurationListResponse, PhoneNumberConfigurationListResponsesDefaultFlatPagination, PhoneNumberConfigurations } from "./phone-number-configurations.mjs";
import * as PhoneNumberExtensionsAPI from "./phone-number-extensions.mjs";
import { PhoneNumberExtensionCreateParams, PhoneNumberExtensionCreateResponse, PhoneNumberExtensionDeleteParams, PhoneNumberExtensionDeleteResponse, PhoneNumberExtensionListParams, PhoneNumberExtensions, PortingPhoneNumberExtension, PortingPhoneNumberExtensionsDefaultFlatPagination } from "./phone-number-extensions.mjs";
import * as VerificationCodesAPI from "./verification-codes.mjs";
import { VerificationCodeListParams, VerificationCodeListResponse, VerificationCodeListResponsesDefaultFlatPagination, VerificationCodeSendParams, VerificationCodeVerifyParams, VerificationCodeVerifyResponse, VerificationCodes } from "./verification-codes.mjs";
...
export declare class PortingOrders extends APIResource {
     ...
     * ```
     */
    list(query?: PortingOrderListParams | null | undefined, options?: RequestOptions): PagePromise<PortingOrdersDefaultFlatPagination, PortingOrder>;
    /**
     ...
     * ```
     */
    retrieveRequirements(id: string, query?: PortingOrderRetrieveRequirementsParams | null | undefined, options?: RequestOptions): PagePromise<PortingOrderRetrieveRequirementsResponsesDefaultFlatPagination, PortingOrderRetrieveRequirementsResponse>;
    /**
...
export type PortingOrderRetrieveRequirementsResponsesDefaultFlatPagination = DefaultFlatPagination<PortingOrderRetrieveRequirementsResponse>;
export type PortingOrdersActivationJobsDefaultFlatPagination = DefaultFlatPagination<PortingOrdersActivationJob>;
...
export declare namespace PortingOrder {
...
export interface PortingOrderActivationSettings {
     ...
     * Activation status
     */
    activation_status?: 'New' | 'Pending' | 'Conflict' | 'Cancel Pending' | 'Failed' | 'Concurred' | 'Activate RDY' | 'Disconnect Pending' | 'Concurrence Sent' | 'Old' | 'Sending' | 'Active' | 'Cancelled' | null;
    /**
...
export declare namespace PortingOrders {
    ...
    export { PhoneNumberConfigurations as PhoneNumberConfigurations, type PhoneNumberConfigurationCreateResponse as PhoneNumberConfigurationCreateResponse, type PhoneNumberConfigurationListResponse as PhoneNumberConfigurationListResponse, type PhoneNumberConfigurationListResponsesDefaultFlatPagination as PhoneNumberConfigurationListResponsesDefaultFlatPagination, type PhoneNumberConfigurationCreateParams as PhoneNumberConfigurationCreateParams, type PhoneNumberConfigurationListParams as PhoneNumberConfigurationListParams, };
    ...
    export { ActivationJobs as ActivationJobs, type ActivationJobRetrieveResponse as ActivationJobRetrieveResponse, type ActivationJobUpdateResponse as ActivationJobUpdateResponse, type ActivationJobRetrieveParams as ActivationJobRetrieveParams, type ActivationJobUpdateParams as ActivationJobUpdateParams, type ActivationJobListParams as ActivationJobListParams, };
    export { AdditionalDocuments as AdditionalDocuments, type AdditionalDocumentCreateResponse as AdditionalDocumentCreateResponse, type AdditionalDocumentListResponse as AdditionalDocumentListResponse, type AdditionalDocumentListResponsesDefaultFlatPagination as AdditionalDocumentListResponsesDefaultFlatPagination, type AdditionalDocumentCreateParams as AdditionalDocumentCreateParams, type AdditionalDocumentListParams as AdditionalDocumentListParams, type AdditionalDocumentDeleteParams as AdditionalDocumentDeleteParams, };
    export { Comments as Comments, type CommentCreateResponse as CommentCreateResponse, type CommentListResponse as CommentListResponse, type CommentListResponsesDefaultFlatPagination as CommentListResponsesDefaultFlatPagination, type CommentCreateParams as CommentCreateParams, type CommentListParams as CommentListParams, };
    export { VerificationCodes as VerificationCodes, type VerificationCodeListResponse as VerificationCodeListResponse, type VerificationCodeVerifyResponse as VerificationCodeVerifyResponse, type VerificationCodeListResponsesDefaultFlatPagination as VerificationCodeListResponsesDefaultFlatPagination, type VerificationCodeListParams as VerificationCodeListParams, type VerificationCodeSendParams as VerificationCodeSendParams, type VerificationCodeVerifyParams as VerificationCodeVerifyParams, };
    export { ActionRequirements as ActionRequirements, type ActionRequirementListResponse as ActionRequirementListResponse, type ActionRequirementInitiateResponse as ActionRequirementInitiateResponse, type ActionRequirementListResponsesDefaultFlatPagination as ActionRequirementListResponsesDefaultFlatPagination, type ActionRequirementListParams as ActionRequirementListParams, type ActionRequirementInitiateParams as ActionRequirementInitiateParams, };
    export { AssociatedPhoneNumbers as AssociatedPhoneNumbers, type PortingAssociatedPhoneNumber as PortingAssociatedPhoneNumber, type AssociatedPhoneNumberCreateResponse as AssociatedPhoneNumberCreateResponse, type AssociatedPhoneNumberDeleteResponse as AssociatedPhoneNumberDeleteResponse, type PortingAssociatedPhoneNumbersDefaultFlatPagination as PortingAssociatedPhoneNumbersDefaultFlatPagination, type AssociatedPhoneNumberCreateParams as AssociatedPhoneNumberCreateParams, type AssociatedPhoneNumberListParams as AssociatedPhoneNumberListParams, type AssociatedPhoneNumberDeleteParams as AssociatedPhoneNumberDeleteParams, };
    export { PhoneNumberBlocks as PhoneNumberBlocks, type PortingPhoneNumberBlock as PortingPhoneNumberBlock, type PhoneNumberBlockCreateResponse as PhoneNumberBlockCreateResponse, type PhoneNumberBlockDeleteResponse as PhoneNumberBlockDeleteResponse, type PortingPhoneNumberBlocksDefaultFlatPagination as PortingPhoneNumberBlocksDefaultFlatPagination, type PhoneNumberBlockCreateParams as PhoneNumberBlockCreateParams, type PhoneNumberBlockListParams as PhoneNumberBlockListParams, type PhoneNumberBlockDeleteParams as PhoneNumberBlockDeleteParams, };
    export { PhoneNumberExtensions as PhoneNumberExtensions, type PortingPhoneNumberExtension as PortingPhoneNumberExtension, type PhoneNumberExtensionCreateResponse as PhoneNumberExtensionCreateResponse, type PhoneNumberExtensionDeleteResponse as PhoneNumberExtensionDeleteResponse, type PortingPhoneNumberExtensionsDefaultFlatPagination as PortingPhoneNumberExtensionsDefaultFlatPagination, type PhoneNumberExtensionCreateParams as PhoneNumberExtensionCreateParams, type PhoneNumberExtensionListParams as PhoneNumberExtensionListParams, type PhoneNumberExtensionDeleteParams as PhoneNumberExtensionDeleteParams, };
}
