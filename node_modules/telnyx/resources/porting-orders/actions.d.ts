...
export declare namespace ActionCancelResponse {
    interface Meta {
        /**
...
export declare namespace ActionConfirmResponse {
    interface Meta {
        /**
         * Link to list all phone numbers
         */
...
export declare namespace ActionShareResponse {
    interface Data {
        /**
...
export declare namespace Actions {
    export { type ActionActivateResponse as ActionActivateResponse, type ActionCancelResponse as ActionCancelResponse, type ActionConfirmResponse as ActionConfirmResponse, type ActionShareResponse as ActionShareResponse, type ActionShareParams as ActionShareParams, };
}
