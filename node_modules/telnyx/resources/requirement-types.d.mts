 ...
 */
export declare class RequirementTypes extends APIResource {
    /**
...
export declare namespace RequirementTypeListParams {
    /**
     * Consolidated filter parameter for requirement types (deepObject style).
     * Originally: filter[name]
     */
...
export declare namespace RequirementTypes {
    export { type RequirementTypeRetrieveResponse as RequirementTypeRetrieveResponse, type RequirementTypeListResponse as RequirementTypeListResponse, type RequirementTypeListParams as RequirementTypeListParams, };
}
//# sourceMappingURL=requirement-types.d.mts.map