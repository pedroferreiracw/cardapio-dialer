 ...
 */
export declare class CreditAccount extends APIResource {
    /**
...
export declare namespace CreditAccountCreateQuoteResponse {
    interface Data {
        /**
...
export declare namespace CreditAccountSettleResponse {
    interface Data {
        /**
...
export declare namespace CreditAccount {
    export { type CreditAccountCreateQuoteResponse as CreditAccountCreateQuoteResponse, type CreditAccountSettleResponse as CreditAccountSettleResponse, type CreditAccountCreateQuoteParams as CreditAccountCreateQuoteParams, type CreditAccountSettleParams as CreditAccountSettleParams, };
}
//# sourceMappingURL=credit-account.d.mts.map