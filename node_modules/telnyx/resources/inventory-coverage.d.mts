 ...
 * Inventory Level
 */
export declare class InventoryCoverage extends APIResource {
    /**
...
export declare namespace InventoryCoverageListResponse {
    interface Data {
...
export declare namespace InventoryCoverageListParams {
    /**
     * Consolidated filter parameter (deepObject style). Originally: filter[npa],
     * filter[nxx], filter[administrative_area], filter[phone_number_type],
     * filter[country_code], filter[count], filter[features], filter[groupBy]
...
export declare namespace InventoryCoverage {
    export { type InventoryCoverageListResponse as InventoryCoverageListResponse, type InventoryCoverageListParams as InventoryCoverageListParams, };
}
//# sourceMappingURL=inventory-coverage.d.mts.map