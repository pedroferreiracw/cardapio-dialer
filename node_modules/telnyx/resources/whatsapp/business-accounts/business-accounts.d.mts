...
import { PhoneNumberInitializeVerificationParams, PhoneNumberListParams, PhoneNumberListResponse, PhoneNumberListResponsesDefaultFlatPagination, PhoneNumbers } from "./phone-numbers.mjs";
import * as SettingsAPI from "./settings.mjs";
import { SettingRetrieveResponse, SettingUpdateParams, SettingUpdateResponse, Settings, WabaSettings } from "./settings.mjs";
 ...
 */
export declare class BusinessAccounts extends APIResource {
...
export declare namespace BusinessAccountRetrieveResponse {
    interface Data {
        /**
...
export declare namespace BusinessAccounts {
    export { type BusinessAccountRetrieveResponse as BusinessAccountRetrieveResponse, type BusinessAccountListResponse as BusinessAccountListResponse, type BusinessAccountListResponsesDefaultFlatPagination as BusinessAccountListResponsesDefaultFlatPagination, type BusinessAccountListParams as BusinessAccountListParams, };
    ...
    export { Settings as Settings, type WabaSettings as WabaSettings, type SettingRetrieveResponse as SettingRetrieveResponse, type SettingUpdateResponse as SettingUpdateResponse, type SettingUpdateParams as SettingUpdateParams, };
}
