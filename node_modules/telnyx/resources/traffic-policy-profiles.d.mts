 ...
 */
export declare class TrafficPolicyProfiles extends APIResource {
    /**
...
export declare namespace TrafficPolicyProfileDeleteResponse {
    interface Data {
        /**
         * Identifies the resource.
         */
