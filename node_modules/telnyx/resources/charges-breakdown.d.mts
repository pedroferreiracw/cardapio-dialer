...
export declare class ChargesBreakdown extends APIResource {
    /**
...
export declare namespace ChargesBreakdownRetrieveResponse {
    interface Data {
        /**
         * Currency code
         */
...
export declare namespace ChargesBreakdown {
    export { type ChargesBreakdownRetrieveResponse as ChargesBreakdownRetrieveResponse, type ChargesBreakdownRetrieveParams as ChargesBreakdownRetrieveParams, };
}
//# sourceMappingURL=charges-breakdown.d.mts.map