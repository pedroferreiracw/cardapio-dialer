...
import * as FqdnsAPI from "../fqdns.js";
...
export declare class UacConnections extends APIResource {
     ...
     * ```
     */
    list(query?: UacConnectionListParams | null | undefined, options?: RequestOptions): PagePromise<UacConnectionsDefaultFlatPagination, UacConnection>;
    /**
