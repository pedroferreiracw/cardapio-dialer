...
import { DefaultPaginationForMessagingTollfree, } from "../../../core/pagination.mjs";
...
export class Requests extends APIResource {
     ...
     */
    list(query, options) {
        return this._client.getAPIList('/messaging_tollfree/verification/requests', (DefaultPaginationForMessagingTollfree), { query, ...options });
    }
    /**
     ...
     * ```
     */
    retrieveStatusHistory(id, query, options) {
