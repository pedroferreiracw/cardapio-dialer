...
export class TrafficPolicyProfiles extends APIResource {
     ...
     */
    list(query = {}, options) {
        return this._client.getAPIList('/traffic_policy_profiles', (DefaultFlatPagination), {
            query,
            ...options,
        });
    }
     ...
     * ```
     */
    listServices(query = {}, options) {
        return this._client.getAPIList('/traffic_policy_profiles/services', (DefaultFlatPagination), { query, ...options });
    }
}
//# sourceMappingURL=traffic-policy-profiles.mjs.map