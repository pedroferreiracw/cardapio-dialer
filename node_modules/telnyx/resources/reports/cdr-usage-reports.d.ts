 ...
 * Voice usage reports
 */
export declare class CdrUsageReports extends APIResource {
    /**
...
export declare namespace CdrUsageReportFetchSyncResponse {
    interface Data {
        /**
...
export declare namespace CdrUsageReports {
    export { type CdrUsageReportFetchSyncResponse as CdrUsageReportFetchSyncResponse, type CdrUsageReportFetchSyncParams as CdrUsageReportFetchSyncParams, };
}
//# sourceMappingURL=cdr-usage-reports.d.ts.map