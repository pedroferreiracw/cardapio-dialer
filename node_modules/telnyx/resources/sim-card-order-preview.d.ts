 ...
 */
export declare class SimCardOrderPreview extends APIResource {
    /**
...
export declare namespace SimCardOrderPreviewPreviewResponse {
    interface Data {
        /**
...
export declare namespace SimCardOrderPreview {
    export { type SimCardOrderPreviewPreviewResponse as SimCardOrderPreviewPreviewResponse, type SimCardOrderPreviewPreviewParams as SimCardOrderPreviewPreviewParams, };
}
//# sourceMappingURL=sim-card-order-preview.d.ts.map