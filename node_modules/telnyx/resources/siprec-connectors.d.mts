 ...
 */
export declare class SiprecConnectors extends APIResource {
    /**
...
export declare namespace SiprecConnectorCreateResponse {
    interface Data {
        /**
...
export declare namespace SiprecConnectorRetrieveResponse {
    interface Data {
        /**
         * Subdomain to route calls when using Telnyx SRS (optional).
         */
...
export declare namespace SiprecConnectorUpdateResponse {
    interface Data {
        /**
         * Subdomain to route calls when using Telnyx SRS (optional).
         */
