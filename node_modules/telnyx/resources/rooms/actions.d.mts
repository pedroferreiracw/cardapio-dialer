...
export declare namespace ActionGenerateJoinClientTokenResponse {
    interface Data {
        token?: string;
...
export declare namespace ActionRefreshClientTokenResponse {
    interface Data {
        token?: string;
        /**
         * ISO 8601 timestamp when the token expires.
