...
export declare class TextToSpeech extends APIResource {
     ...
     */
    createSpeech(body: TextToSpeechCreateSpeechParams, options?: RequestOptions): APIPromise<TextToSpeechCreateSpeechResponse>;
    /**
     ...
     */
    generateSpeech(query?: TextToSpeechGenerateSpeechParams | null | undefined, options?: RequestOptions): APIPromise<void>;
    /**
...
export declare namespace StreamServerEvent {
    /**
...
export declare namespace TextToSpeechCreateSpeechParams {
    /**
     * AWS Polly provider-specific parameters.
     */
    interface Aws {
...
export interface TextToSpeechStreamParams {
     ...
     */
    provider?: 'aws' | 'telnyx' | 'azure' | 'elevenlabs' | 'minimax' | 'murfai' | 'rime' | 'resemble' | 'inworld';
    /**
...
//# sourceMappingURL=text-to-speech.d.mts.map