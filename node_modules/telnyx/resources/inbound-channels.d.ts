 ...
 * Voice Channels
 */
export declare class InboundChannels extends APIResource {
    /**
...
export declare namespace InboundChannelUpdateResponse {
    interface Data {
        /**
...
export declare namespace InboundChannelListResponse {
    interface Data {
        /**
...
export declare namespace InboundChannels {
    export { type InboundChannelUpdateResponse as InboundChannelUpdateResponse, type InboundChannelListResponse as InboundChannelListResponse, type InboundChannelUpdateParams as InboundChannelUpdateParams, };
}
//# sourceMappingURL=inbound-channels.d.ts.map