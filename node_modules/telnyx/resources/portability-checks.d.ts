 ...
 */
export declare class PortabilityChecks extends APIResource {
    /**
...
export declare namespace PortabilityCheckRunResponse {
    interface Data {
        /**
...
export declare namespace PortabilityChecks {
    export { type PortabilityCheckRunResponse as PortabilityCheckRunResponse, type PortabilityCheckRunParams as PortabilityCheckRunParams, };
}
//# sourceMappingURL=portability-checks.d.ts.map