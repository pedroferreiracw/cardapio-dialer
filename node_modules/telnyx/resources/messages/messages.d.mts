...
import { RcGenerateDeeplinkParams, RcGenerateDeeplinkResponse, RcSendParams, RcSendResponse, Rcs } from "./rcs.mjs";
...
export declare namespace WhatsappContact {
    interface Address {
        city?: string;
        country?: string;
        country_code?: string;
...
export declare namespace WhatsappInteractive {
    interface Action {
        button?: string;
...
export declare namespace WhatsappMessageContent {
    /**
     * Template message object. Provide either template_id or name + language to
     * identify the template.
     */
...
export declare namespace MessageSendWhatsappResponse {
    interface Data {
        /**
         * message ID
         */
