...
class Messages extends resource_1.APIResource {
     ...
     * ```
     */
    retrieveGroupMessages(messageID, options) {
        return this._client.get((0, path_1.path) `/messages/group/${messageID}`, options);
    }
    /**
     ...
     * ```
     */
    sendWithAlphanumericSender(body, options) {
