...
export declare namespace RcSendResponse {
    interface Data {
        /**
         * message ID
         */
...
export declare namespace RcSendParams {
...
export declare namespace Rcs {
    export { type RcGenerateDeeplinkResponse as RcGenerateDeeplinkResponse, type RcSendResponse as RcSendResponse, type RcGenerateDeeplinkParams as RcGenerateDeeplinkParams, type RcSendParams as RcSendParams, };
}
