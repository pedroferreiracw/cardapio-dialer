...
import { type WebhookUnwrapOptions } from "../lib/webhooks.mjs";
...
export declare namespace CallAIGatherEnded {
    interface Payload {
        /**
...
export declare namespace CallAIGatherMessageHistoryUpdated {
    interface Payload {
        /**
         * Call ID used to issue commands via Call Control API.
         */
...
export declare namespace CallAIGatherPartialResults {
    interface Payload {
        /**
         * Call ID used to issue commands via Call Control API.
         */
...
export declare namespace CallAnswered {
    interface Payload {
        /**
         * Call ID used to issue commands via Call Control API.
         */
...
export declare namespace CallBridged {
    interface Payload {
        /**
         * Call ID used to issue commands via Call Control API.
         */
...
export declare namespace CallConversationEnded {
    interface Payload {
        /**
...
export declare namespace CallConversationInsightsGenerated {
    interface Payload {
        /**
         * Call ID used to issue commands via Call Control API.
         */
...
export declare namespace CallDtmfReceived {
    interface Payload {
        /**
         * Call ID used to issue commands via Call Control API.
         */
...
export declare namespace CallEnqueued {
    interface Payload {
        /**
         * Call ID used to issue commands via Call Control API.
         */
...
export declare namespace CallForkStarted {
    interface Payload {
        /**
...
export declare namespace CallForkStopped {
    interface Payload {
        /**
         * Unique ID for controlling the call.
         */
...
export declare namespace CallGatherEnded {
    interface Payload {
        /**
         * Call ID used to issue commands via Call Control API.
         */
...
export declare namespace CallHangup {
    interface Payload {
        /**
         * Call ID used to issue commands via Call Control API.
         */
...
export declare namespace CallInitiated {
    interface Payload {
        /**
         * Call ID used to issue commands via Call Control API.
         */
...
export declare namespace CallLeftQueue {
    interface Payload {
        /**
         * Call ID used to issue commands via Call Control API.
         */
...
export declare namespace CallMachineDetectionEnded {
    interface Payload {
        /**
         * Call ID used to issue commands via Call Control API.
         */
...
export declare namespace CallMachineGreetingEnded {
    interface Payload {
        /**
         * Call ID used to issue commands via Call Control API.
         */
...
export declare namespace CallMachinePremiumDetectionEnded {
    interface Payload {
        /**
         * Call ID used to issue commands via Call Control API.
         */
...
export declare namespace CallMachinePremiumGreetingEnded {
    interface Payload {
        /**
         * Call ID used to issue commands via Call Control API.
         */
...
export declare namespace CallPlaybackEnded {
    interface Payload {
        /**
         * Call ID used to issue commands via Call Control API.
         */
...
export declare namespace CallPlaybackStarted {
    interface Payload {
        /**
         * Call ID used to issue commands via Call Control API.
         */
...
export declare namespace CallRecordingError {
    interface Payload {
        /**
         * Call ID used to issue commands via Call Control API.
         */
...
export declare namespace CallRecordingSaved {
    interface Payload {
        /**
         * ID that is unique to the call and can be used to correlate webhook events.
         */
...
export declare namespace CallRecordingTranscriptionSaved {
    interface Payload {
        /**
         * Call ID used to issue commands via Call Control API.
         */
...
export declare namespace CallReferCompleted {
    interface Payload {
        /**
         * Unique ID for controlling the call.
         */
...
export declare namespace CallReferFailed {
    interface Payload {
        /**
         * Unique ID for controlling the call.
         */
...
export declare namespace CallReferStarted {
    interface Payload {
        /**
         * Unique ID for controlling the call.
         */
...
export declare namespace CallSiprecFailed {
    interface Payload {
        /**
         * Call ID used to issue commands via Call Control API.
         */
...
export declare namespace CallSiprecStarted {
    interface Payload {
        /**
         * Call ID used to issue commands via Call Control API.
         */
...
export declare namespace CallSiprecStopped {
    interface Payload {
        /**
         * Call ID used to issue commands via Call Control API.
         */
...
export declare namespace CallSpeakEnded {
    interface Payload {
        /**
         * Call ID used to issue commands via Call Control API.
         */
...
export declare namespace CallSpeakStarted {
    interface Payload {
        /**
         * Call ID used to issue commands via Call Control API.
         */
...
export declare namespace CallStreamingFailed {
    interface Payload {
        /**
         * Call ID used to issue commands via Call Control API.
         */
...
export declare namespace CallStreamingStarted {
    interface Payload {
        /**
         * Call ID used to issue commands via Call Control API.
         */
...
export declare namespace CallStreamingStopped {
    interface Payload {
        /**
         * Call ID used to issue commands via Call Control API.
         */
...
export declare namespace ConferenceCreated {
    interface Payload {
        /**
         * Call ID used to issue commands via Call Control API.
         */
...
export declare namespace ConferenceEnded {
    interface Payload {
        /**
         * Call ID used to issue commands via Call Control API.
         */
...
export declare namespace ConferenceFloorChanged {
    interface Payload {
        /**
...
export declare namespace ConferenceParticipantJoined {
    interface Payload {
        /**
         * Call ID used to issue commands via Call Control API.
         */
...
export declare namespace ConferenceParticipantLeft {
    interface Payload {
        /**
         * Call ID used to issue commands via Call Control API.
         */
...
export declare namespace ConferenceParticipantPlaybackEnded {
    interface Payload {
        /**
...
export declare namespace ConferenceParticipantPlaybackStarted {
    interface Payload {
        /**
         * Participant's call ID used to issue commands via Call Control API.
         */
...
export declare namespace ConferenceParticipantSpeakEnded {
    interface Payload {
        /**
         * Participant's call ID used to issue commands via Call Control API.
         */
...
export declare namespace ConferenceParticipantSpeakStarted {
    interface Payload {
        /**
         * Participant's call ID used to issue commands via Call Control API.
         */
...
export declare namespace ConferencePlaybackEnded {
    interface Payload {
        /**
         * ID of the conference the text was spoken in.
         */
...
export declare namespace ConferencePlaybackStarted {
    interface Payload {
        /**
         * ID of the conference the text was spoken in.
         */
...
export declare namespace ConferenceRecordingSaved {
    interface Payload {
        /**
         * Participant's call ID used to issue commands via Call Control API.
         */
...
export declare namespace ConferenceSpeakEnded {
    interface Payload {
        /**
         * ID of the conference the text was spoken in.
         */
...
export declare namespace ConferenceSpeakStarted {
    interface Payload {
        /**
         * ID of the conference the text was spoken in.
         */
...
export declare namespace FaxDelivered {
    interface Data {
        /**
         * Identifies the type of resource.
         */
...
export declare namespace FaxFailed {
    interface Data {
        /**
         * Identifies the type of resource.
         */
...
export declare namespace FaxMediaProcessed {
    interface Data {
        /**
         * Identifies the type of resource.
         */
...
export declare namespace FaxQueued {
    interface Data {
        /**
         * Identifies the type of resource.
         */
...
export declare namespace FaxSendingStarted {
    interface Data {
        /**
         * Identifies the type of resource.
         */
...
export declare namespace NumberOrderStatusUpdate {
    interface Data {
        /**
         * Unique identifier for the event
         */
...
export declare namespace CallCostWebhookEvent {
    interface Data {
        /**
