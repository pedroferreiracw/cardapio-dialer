...
const ExternalVettingAPI = tslib_1.__importStar(require("./external-vetting.js"));
const external_vetting_1 = require("./external-vetting.js");
...
class Brand extends resource_1.APIResource {
    ...
    retrieve(brandID, options) {
        return this._client.get((0, path_1.path) `/10dlc/brand/${brandID}`, options);
    }
    /**
    ...
    update(brandID, body, options) {
        return this._client.put((0, path_1.path) `/10dlc/brand/${brandID}`, { body, ...options });
    }
    /**
     ...
     */
    list(query = {}, options) {
        return this._client.getAPIList('/10dlc/brand', (pagination_1.PerPagePaginationV2), {
            query,
            ...options,
        });
    }
    ...
    delete(brandID, options) {
        return this._client.delete((0, path_1.path) `/10dlc/brand/${brandID}`, {
            ...options,
    ...
    getFeedback(brandID, options) {
        return this._client.get((0, path_1.path) `/10dlc/brand/feedback/${brandID}`, options);
    }
    /**
     ...
     * ```
     */
    getSMSOtpByReference(referenceID, query = {}, options) {
        return this._client.get((0, path_1.path) `/10dlc/brand/smsOtp/${referenceID}`, { query, ...options });
    }
    /**
    ...
    resend2faEmail(brandID, options) {
        return this._client.post((0, path_1.path) `/10dlc/brand/${brandID}/2faEmail`, {
            ...options,
            headers: (0, headers_1.buildHeaders)([{ Accept: '*/*' }, options?.headers]),
        });
    }
    ...
    retrieveSMSOtpStatus(brandID, options) {
        return this._client.get((0, path_1.path) `/10dlc/brand/${brandID}/smsOtp`, options);
    }
    /**
    ...
    revet(brandID, options) {
        return this._client.put((0, path_1.path) `/10dlc/brand/${brandID}/revet`, options);
    }
    /**
    ...
    triggerSMSOtp(brandID, body, options) {
        return this._client.post((0, path_1.path) `/10dlc/brand/${brandID}/smsOtp`, { body, ...options });
    }
    /**
    ...
    verifySMSOtp(brandID, body, options) {
        return this._client.put((0, path_1.path) `/10dlc/brand/${brandID}/smsOtp`, {
            body,
            ...options,
            headers: (0, headers_1.buildHeaders)([{ Accept: '*/*' }, options?.headers]),
        });
...
exports.Brand = Brand;
Brand.ExternalVetting = external_vetting_1.ExternalVetting;
