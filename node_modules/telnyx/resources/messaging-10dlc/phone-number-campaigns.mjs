...
export class PhoneNumberCampaigns extends APIResource {
     ...
     * ```
     */
    update(campaignPhoneNumber, body, options) {
     ...
     */
    list(query = {}, options) {
        return this._client.getAPIList('/10dlc/phone_number_campaigns', (PerPagePaginationV2), { query, ...options });
    }
    /**
...
//# sourceMappingURL=phone-number-campaigns.mjs.map