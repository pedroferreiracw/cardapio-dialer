 ...
 */
export declare class RegulatoryRequirements extends APIResource {
    /**
...
export declare namespace RegulatoryRequirementRetrieveResponse {
    interface Data {
        action?: string;
        country_code?: string;
...
export declare namespace RegulatoryRequirementRetrieveParams {
    /**
     * Consolidated filter parameter (deepObject style). Originally:
     * filter[phone_number], filter[requirement_group_id], filter[country_code],
     * filter[phone_number_type], filter[action]
...
export declare namespace RegulatoryRequirements {
    export { type RegulatoryRequirementRetrieveResponse as RegulatoryRequirementRetrieveResponse, type RegulatoryRequirementRetrieveParams as RegulatoryRequirementRetrieveParams, };
}
//# sourceMappingURL=regulatory-requirements.d.ts.map