...
export interface MetadataRetrieveResponse {
     ...
     */
    query_parameters: {
        [key: string]: MetadataRetrieveResponse.QueryParameters;
    };
    record_types: Array<MetadataRetrieveResponse.RecordType>;
}
export declare namespace MetadataRetrieveResponse {
    interface Meta {
        last_updated: string;
...
export declare namespace MetadataRetrieveRecordTypeResponse {
    interface Meta {
...
export declare namespace Metadata {
    export { type ChildRelationshipInfo as ChildRelationshipInfo, type MetadataFieldMapping as MetadataFieldMapping, type ParentRelationshipInfo as ParentRelationshipInfo, type MetadataRetrieveResponse as MetadataRetrieveResponse, type MetadataRetrieveRecordTypeResponse as MetadataRetrieveRecordTypeResponse, };
}
