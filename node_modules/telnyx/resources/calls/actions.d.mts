...
export declare namespace TranscriptionEngineGoogleConfig {
    interface SpeechContext {
        /**
         * Boost factor for the speech context.
         */
...
export declare namespace ActionAddAIAssistantMessagesParams {
    /**
...
export interface ActionAnswerParams {
    ...
    webhook_retries_policies?: {
        [key: string]: ActionAnswerParams.WebhookRetriesPolicies;
    };
    /**
...
export declare namespace ActionJoinAIAssistantParams {
...
export interface ActionStartAIAssistantParams {
     ...
     */
    participants?: Array<ActionStartAIAssistantParams.Participant>;
    /**
...
export declare namespace ActionStartNoiseSuppressionParams {
    /**
     * Configuration parameters for noise suppression engines. Different engines
     * support different parameters.
     */
    interface NoiseSuppressionEngineConfig {
        /**
...
export declare namespace ActionStartStreamingParams {
...
export interface ActionTransferParams {
     ...
     */
    webhook_retries_policies?: {
        [key: string]: ActionTransferParams.WebhookRetriesPolicies;
    };
    /**
     * Use this field to override the URL for which Telnyx will send subsequent
     * webhooks to for this call.
