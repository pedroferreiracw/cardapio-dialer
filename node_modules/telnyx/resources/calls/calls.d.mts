...
export declare namespace CallAssistantRequest {
    /**
     * External LLM configuration for bringing your own LLM endpoint.
     */
...
export interface CallDialParams {
    ...
    webhook_retries_policies?: {
        [key: string]: CallDialParams.WebhookRetriesPolicies;
    };
    /**
...
export declare namespace CallDialParams {
    ...
    interface WebhookRetriesPolicies {
        /**
