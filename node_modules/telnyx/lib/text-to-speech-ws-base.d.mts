import { TextToSpeechEmitter, TextToSpeechStreamMessage } from "./text-to-speech-ws-internal.mjs";
...
import * as TextToSpeechAPI from "../resources/text-to-speech/text-to-speech.mjs";
...
export declare abstract class TextToSpeechWSBase<TSocket extends WebSocketLike> extends TextToSpeechEmitter {
    url: URL;
    socket: TSocket;
    ...
    constructor(client: Telnyx, parameters?: Record<string, unknown> | undefined, options?: TextToSpeechWSBaseOptions | undefined);
...
//# sourceMappingURL=text-to-speech-ws-base.d.mts.map